...
class optimization_MGD:
    ...
    def tv_penalty(self, image):
        ...
        encourages smoothness by penalizing large gradients between adjacent pixels.
    ...
    def tv_sq_penalty(self, image):
        """
        Compute the Total Variation square

        This method computes the Total Variation squared regularization for a given image. This only  
        ...
        # Compute the TV regularization term for each image
        tv_sq = torch.sum( gradient_x**2 + gradient_y**2 )
...
# class optim_OAP_regularize(optim_OAP):
