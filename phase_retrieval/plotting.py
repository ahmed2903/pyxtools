...
def three_lists_one_slider(img_list1, img_list2, img_list3, scale_fac=0.3, vmin1 = None, vmax1 = None, vmin2=None, vmax2=None, vmin3=None, vmax3=None, cmap1 = 'viridis', cmap2 = 'viridis'):
    """Displays a list of coherent images and allows scrolling through them via a slider."""
    ...
    # Plot the second image
    im3 = axes[2].imshow(img_list2[0], vmin = vmin2, vmax = vmax2, cmap=cmap2)
    axes[2].set_title(f"Image 1 {0}/{num_images - 1}")
    #axes[1].axis('off')  # Hide axes
    plt.colorbar(im2, ax=axes[1], fraction=0.046, pad=0.04)
